  ...
  return (
    <footer className="bg-secondary-dark text-white mt-auto">
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 font-secondary">
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-primary font-bold mb-4">Contact Us</h3>
          ...
          {/* Hours */}
          <div>
            <h3 className="text-xl font-primary font-bold mb-4">Hours</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-primary font-bold mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-primary-light transition"
                >
          ...
          {/* Copyright */}
          <div className="border-t border-secondary mt-8 pt-6 text-center text-secondary-light font-secondary">
